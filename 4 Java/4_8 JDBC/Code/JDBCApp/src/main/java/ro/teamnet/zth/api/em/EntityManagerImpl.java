...
public class EntityManagerImpl implements EntityManager{
    ...
    @Override
    public <T> T findById(Class<T> entityClass, Long id) throws ClassNotFoundException {//throws SQLException, ClassNotFoundException, IllegalAccessException, InstantiationException {
