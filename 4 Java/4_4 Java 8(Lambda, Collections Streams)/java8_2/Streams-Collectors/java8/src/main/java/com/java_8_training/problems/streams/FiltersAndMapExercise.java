...
public class FiltersAndMapExercise {
    ...
    public static List<String> findPersonByName(String name){
        ...
        personName = input.filter(value -> value =="Jack").collect(toList());
        return personName;
    }
    ...
    public static List<Integer> filterNull(){
        ...
        evenNumbers = input.filter(n -> n != null).collect(toList());
        return evenNumbers;
    }
    ...
    public static List<Person> findPersonByAgeAndName(List<Person> personList, String name, Integer age){
        ...
        persons = personList.stream().filter(person -> person.name == "James" && person.age == 20).collect(toList());
        return persons;
    }
    ...
    public static List<Integer> doubleNumbers() {
        ...
        doubleNumbers = input.map(n -> n * 2).collect(toList());
    ...
    public static List<String> getOnlyNames(List<Person> personList){
        ...
        //TODO #6
        // HINT: use map
        collect = personList.stream().map(Person::getName).collect(toList());
        return  collect;
    }
    ...
    public static Optional<Person> findFirstAllMalePersons(List<Person> personList){
        ...
        //TODO #9
        personOptional = personList.stream().filter(person -> person.isMale() == true).findFirst();
    ...
    public static int findTheMinimumNumber(){
        ...
        // HINT: use reduce
        int min =0;
        min = input.reduce(Integer.MAX_VALUE, (a, b) -> Integer.min(a, b));
        return min;
    }
    ...
    public static int findTheYoungestPerson(List<Person> personList){
        ...
        int min = 0;
        min = personList.stream().map(Person::getAge).reduce(Integer.MAX_VALUE, (a, b) -> Integer.min(a, b));
        return min;
    }
    ...
    public static double findAgeAverage(List<Person> personList){
        double sum = 0;
        //TODO #13
        sum = personList.stream().mapToInt(Person::getAge).sum();
    ...
    public static List<Nationality> findNationalityByName(List<Person> personList){
        ...
        persons = personList.stream().filter(person -> person.getName().startsWith("J") == true).map(Person::getNationality)
    ...
    public static Optional<Integer> findSquareDivisibleBy3(){
        ...
        List<Integer> someNumbers = Arrays.asList(1, 2, 36, 4, 9);

        //TODO #15
        Optional<Integer> firstSquareDivisibleByThree = Optional.empty();
        firstSquareDivisibleByThree = someNumbers.stream().filter(n ->  n % 9 ==0 && n == Math.pow((int)Math.sqrt(n), 2))
                .findFirst();
    ...
    public static int sumStringLength(){
        ...
        int sum = 0;
        //TODO #16
        sum = strings.stream().mapToInt(word -> word.length()).sum();
        return sum;
    }
