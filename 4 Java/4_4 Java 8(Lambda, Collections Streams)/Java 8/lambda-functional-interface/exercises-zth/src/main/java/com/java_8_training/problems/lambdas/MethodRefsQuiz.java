...
public class MethodRefsQuiz {
    ...
    public void startsWithNumberQuiz() {
        //TODO: refactor to use a method reference
        Predicate<String> startsWithNumber = this::startsWithNumber;//(string) -> startsWithNumber(string);
    ...
    public void formatText() {
        ...
        //TODO: refactor to use a method reference
        Function<String, String> formatText = formatter::format;//(String title) -> formatter.format(title);

        //TODO: use the formatText function to test the film title and print it to the console
        String s = formatText.apply(filmTitle);
