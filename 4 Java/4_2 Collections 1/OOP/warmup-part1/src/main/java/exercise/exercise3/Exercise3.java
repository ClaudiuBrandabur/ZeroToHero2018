...
public class Exercise3 {
    ...
    public void addElementsToSets(){
        ...
        for(int i = 0; i < listToAdd.size(); i++){
            hs.add(listToAdd.get(i));
            lsh.add(listToAdd.get(i));
            ts.add(listToAdd.get(i));
        }

        // TODO Exercise #3 c) Check the content of the Sets
        System.out.println("\nThe elements contained in the first Set: " + hs);

        System.out.println("\nThe elements contained in the second Set: " + lsh);

        System.out.println("\nThe elements contained in the third Set: " + ts);

        ts.add("A");
        ts.add("collection");
        System.out.println("\nThe elements contained in the TreeSet after inserting two duplicates: " +ts);
